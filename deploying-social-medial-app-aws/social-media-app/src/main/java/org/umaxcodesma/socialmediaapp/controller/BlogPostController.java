...
import org.umaxcodesma.socialmediaapp.domain.dto.response.SuccessResponse;
...
public class BlogPostController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<SuccessResponse> getBlogPost(@PathVariable("id") String postId) {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<SuccessResponse> updateBlogPost(@PathVariable("id") String postId, @RequestBody PostCreationRequestDTO request) {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<SuccessResponse> deleteBlogPost(@PathVariable("id") String postId) {
